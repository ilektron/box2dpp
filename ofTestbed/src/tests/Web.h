...
public:
    Web()
    {
...

        {
            ...
            jd.bodyA = ground;
            jd.bodyB = m_bodies[0];
            jd.localAnchorA = {{10.0f, 0.0f}};
            jd.localAnchorB = {{0.5f, -0.5f}};
    ...
    {
        Test::Step(settings);
        g_debugDraw.DrawString({{5.0f, static_cast<float>(m_textLine)}}, "This demonstrates a soft distance joint.");
        m_textLine += DRAW_STRING_NEW_LINE;
        g_debugDraw.DrawString({{5.0f, static_cast<float>(m_textLine)}}, "Press: (b) to delete a body, (j) to delete a joint");
        m_textLine += DRAW_STRING_NEW_LINE;
    }
