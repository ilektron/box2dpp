...
void b2Body::ResetMassData()
{
    ...
    if (m_type == b2Body::STATIC_BODY || m_type == b2Body::KINEMATIC_BODY)
        {
            m_sweep.c0 = m_xf.p;
            m_sweep.c = m_xf.p;
            m_sweep.a0 = m_sweep.a;
    ...
    b2Assert(m_type == b2Body::DYNAMIC_BODY);
...
bool b2Body::ShouldCollide(const b2Body* other) const
{
    ...
    if (m_type != b2Body::DYNAMIC_BODY && other->m_type != b2Body::DYNAMIC_BODY)
        {
            return false;
        }
