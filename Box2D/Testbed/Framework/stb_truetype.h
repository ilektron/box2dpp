                                    ...
                                    if (i == j)
                                    ...
                                    else
                                        {
                                            ...
                                            if (j < len)  // add antialiasing for x1
                                                scanline[j] =
                                                    scanline[j] +
                                                    (stbtt_uint8)(((x1 & FIXMASK) * max_weight) >>
                                                                  FIXSHIFT);
                                            else
                                                j = len;  // clip
    ...
    for (i = 0; i < count; ++i)
        {
            ...
            if (id == target_id)
                {
                    // find the encoding
                    stbtt_int32_t platform = ttUSHORT(fc + loc + 0),
                    ...
                    if (platform == 0 || (platform == 3 && encoding == 1) ||
                        ...
                        {
                            stbtt_int32_t slen = ttUSHORT(fc + loc + 8),
